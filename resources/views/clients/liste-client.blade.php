    ...
    <table class="table table-bordered table-striped">
        <thead class="thead-dark">
            <tr>
                ...
                <th scope="col">vehicule choisi</th>
        ...
        <tbody>
            @foreach ($client as $cl)
                <tr>
                    ...
                    <td> {{$cl->numero }}</td>
                    <td>{{ $cl->email }}</td>
                    <td>{{ $cl->vehicule ? $cl->vehicule->matricule : 'Aucun véhicule associé' }}</td>
                    <td>{{ $cl->heure }} heure</td>
                    <td>{{ $cl->date }}</td>


                    <td>
                        <a href="/update-client/{{ $cl->id }}" class="btn btn-info btn-sm">Modifier</a>
                        <a href="/delete-client/{{ $cl->id }}" class="btn btn-danger btn-sm">Supprimer</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
